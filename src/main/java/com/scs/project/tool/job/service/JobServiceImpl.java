...
import com.scs.common.constant.ScheduleConstants;
...
import com.scs.project.tool.job.mapper.JobMapper;
import com.scs.project.tool.job.util.CronUtils;
import com.scs.project.tool.job.util.ScheduleUtils;
...
public class JobServiceImpl implements IJobService {
    ...
    public void init() throws SchedulerException, TaskException {
        ...
        for (Job job : jobList) {
            ...
            log.info("定时任务:{},定时类型:{}", job, job.getJobGroup());
        }
    }
